...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Enter key pada password field juga submit
...
function handleLogin() {
    ...
    // Gunakan callAPI dari config.js
    callAPI('verifyLogin', {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (token) {
        ...
        callAPI('getCurrentUser', {}, 'GET')
            ...
            .catch(function() {
                // Session tidak valid, tetap di halaman login
